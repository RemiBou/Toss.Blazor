    ...
    public class CosmosDBFixture : IDisposable
    {
        public CosmosDBFixture()
        {
            var config = new ConfigurationBuilder()
               ...
               .Build();
            Client = new DocumentClient(new Uri(config.GetValue("CosmosDBEndpoint", "https://localhost:8081")), "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==",new JsonSerializerSettings()
            {
