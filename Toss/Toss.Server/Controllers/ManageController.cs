...
namespace AuthenticationSample.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index([FromBody] AccountViewModel model)
        {
            ...
            {
                return new BadRequestObjectResult(ModelState.ToDictionary(s => s.Key,s => string.Join(",",s.Value.Errors.Select(e => e.ErrorMessage))));
            }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("AuthenticationSample"),
